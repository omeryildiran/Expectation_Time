...
for thisTrials in trialss:
    ...
    i=0
    # keep track of which components have finished
    trialComponents = [audCueStart, outerDisk, distractor, target, placeholder, audCueEnd, sapce2pass_2, fixationPoint,responsePointer,cueForRep]
    ...
    while continueRoutine:
        ...
        # *mouse* updates
        if mouse.status == NOT_STARTED and frameN >= 120+preTrialInterval+round(0.5*fps):
            # keep track of start time/frame for later
