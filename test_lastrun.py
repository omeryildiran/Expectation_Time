...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\omeru\\Documents\\Omer_Repos\\Internship Pascal\\Expectation_Shapes_Perceived_Time\\test_lastrun.py',
...
trialComponents = [mouse, key_resp, polygon]
...
while continueRoutine:
    ...
    if polygon.status == STARTED:  # only update if drawing
        polygon.setPos((x_coord, y_coord), log=False)
