...
test_trialN=-1  # counter for test trials
for thisTrials in trialss:
    ...
    trialComponents = [audCueStart, outerDisk, target, placeholder, audCueEnd, sapce2pass_2, fixationPoint,responsePointer,cueForRep,mouse]
